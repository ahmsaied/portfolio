...
const timeline = [
  {
    ...
    period: "2022 – Present",
    description:
      "Managing network infrastructure, leading technical teams, overseeing BSS/OSS operations for large-scale telecom systems across Egypt.",
  },
  {
    ...
    period: "2020 – 2022",
    description:
      "Built the 'Habibi App' — a social platform with real-time chat, Google Maps, push notifications, and media sharing using Flutter & Clean Architecture.",
  },
  {
    ...
    period: "2015 – 2022",
    description:
      "Radio network Implementation, KPI analysis, and coverage enhancement for GSM/3G networks.",
  },
];
