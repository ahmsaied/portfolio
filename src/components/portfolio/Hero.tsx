...
const socials = [
  ...
  { icon: Linkedin, href: "https://www.linkedin.com/in/ahmsaied/", label: "LinkedIn" },
  { icon: ExternalLink, href: "https://stackoverflow.com/users/9513914/ahmed-saied", label: "StackOverflow" },
    ...
    <div className="container mx-auto text-center relative z-10">
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
        ...
        <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto mb-8">
          Building intelligent systems with LLMs & AI Agents · Flutter & .NET Full-Stack Developer · 14+ Years Telecom Engineering
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-10">
          ...
          <Button size="lg" variant="outline" asChild>
            <a href="/assets/Ahmed_Khedr_Resume.pdf" download>Download Resume</a>
          </Button>
        </div>
